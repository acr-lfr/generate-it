...
var GenerateOperation = /** @class */ (function () {
     ...
     * @param config
     */
    GenerateOperation.prototype.files = function (config) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.file(config, operation, operationNameItem)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
     ...
     */
    GenerateOperation.prototype.file = function (config, operation, operationName, verbose, additionalTplContent) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        renderedContent = TemplateRenderer_1["default"].load(data.toString(), this.templateVariables(operationName, operation, config, additionalTplContent, verbose), ext);
     ...
     * @param verbose
     */
    GenerateOperation.prototype.templateVariables = function (operationName, operation, config, additionalTplContent, verbose) {
        if (additionalTplContent === void 0) { additionalTplContent = {}; }
        if (verbose === void 0) { verbose = false; }
        return tslib_1.__assign({ operation_name: lodash_1["default"].camelCase(operationName.replace(/[}{]/g, '')), operations: operation, swagger: config.data.swagger, mockServer: config.mockServer || false, verbose: verbose }, additionalTplContent);
    };
