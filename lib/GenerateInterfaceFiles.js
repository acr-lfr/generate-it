...
class GenerateInterfaceFiles {
  ...
  parseDefinition (interfaceText, definitionName) {
    ...
    global.verboseLogging('Interface file:')
    global.verboseLogging(data)
    global.verboseLogging(definitionName)
    global.verboseLogging(interfaceText)
    global.verboseLogging(' ')
...
module.exports = GenerateInterfaceFiles
