...
describe('e2e testing', () => {
  ...
  it('Should have the correct file hashes', async (done) => {
    ...
    const expectedPathHashes = [
      ...
      ['test_server/src/domains/domainsImporter.ts', '40c2afe0eb99354e208ba9833e9fbfd4'],
      ...
      ['test_server/src/http/nodegen/security/definitions.ts', '6b25d2dcc74702d6fa231ea3719eefa2'],
